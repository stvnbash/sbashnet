...
export default function NavLink({ title, url }: {title: string; url: string}) {
    return (
        <Link href={url} passHref>
            ...
            <a className="font-normal text-text1 inline-block rounded-lg hover:text-yellow1 transition-all text-lg focus-visible:outline-none focus-visible:ring ring-offset-navy1 ring-offset-4 ring-red1">
                {title}
            </a>
        </Link>
    )
