...
export default function Navbar() {
    ...
    return (
        <div className="absolute left-0 top-0 max-w-[640px]">
            ...
            {/* <div className="bg-black min-h-screen flex flex-col justify-between max-w-3xl pt-10 px-10 mx-auto"> */}
            <div className="min-h-screen flex flex-col justify-between max-w-3xl pt-10 px-10 mx-auto">
